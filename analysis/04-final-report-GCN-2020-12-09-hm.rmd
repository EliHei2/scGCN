...
# initialization
data_input = 'data_input/cross_hm'
data_tidy  = 'data_tidy/human_mouse'
model_dir  = 'models/cross_hm'
out_dir    = 'output/cross_hm'
time_stamp = format(Sys.Date(), '%Y_%m_%d')
# dirs
## input data
adj1_f     = file.path(data_tidy, 'wi_adj_h_0.1_2020_12_07.txt')
adj2_f     = file.path(data_tidy, 'wi_adj_m_0.1_2020_12_07.txt')
...
comm_f    = file.path(data_tidy, 'gene_communities_h_0.1_2020_12_07.txt')
## labels
...
cell_type_graph <- function(type, title){
    ...
    igraph::V(graph1)$color  = rgb(floor(255*(grp^(1/2))/max(grp^(1/2))), floor(255*(grp^(1/2))/max(grp^(1/2))), 0, maxColorValue=255, alpha=255)
